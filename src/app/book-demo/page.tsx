                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 1.2fr) minmax(300px, 0.8fr)', gap: 'var(--space-12)', alignItems: 'start' }}>
                        ...
                        <div style={{ position: 'sticky', top: 'var(--space-20)' }}>
                            <div style={{
                                ...
                                <div style={{ height: '280px', background: 'var(--color-gray-50)', position: 'relative' }}>
                                    <img
                                        src="/images/success_manager.png"
                                        alt="Braintrust Solutions Team"
                                ...
                                <div style={{ padding: 'var(--space-8)' }}>
                                    <div style={{ display: 'flex', gap: '8px', marginBottom: 'var(--space-4)' }}>
                                        {[1, 2, 3, 4, 5].map(star => (
                                            <svg key={star} width="18" height="18" viewBox="0 0 24 24" fill="var(--color-primary)" stroke="var(--color-primary)" strokeWidth="1">
                                                <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                                            </svg>
                                        ))}
                                    </div>
                                    <p style={{ fontSize: 'var(--text-lg)', fontWeight: 500, fontStyle: 'italic', marginBottom: 'var(--space-4)', lineHeight: 1.6 }}>
                                        "I submitted a request and the team reached out in 15 minutes. The demo was completely tailored to our engineering stack. By far the most impressive AI recruiting platform we've seen."
                                    </p>
                                    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--text-secondary)' }}>
                                        <strong style={{ color: 'var(--text-primary)' }}>Director of Talent</strong>
                                        <br />Fortune 500 Technology Company
                                    </div>
                                </div>
                            </div>
                        </div>
