                ...
                <div className="container">
                    ...
                    <div className="hero__content">
                        ...
                        <div style={{
                            ...
                            flexWrap: 'wrap', gap: '10px', marginTop: 'var(--space-10)',
                        }}>
                            {/* Rating chip */}
                            <div style={{
                                ...
                                <div style={{ display: 'flex', gap: '1px' }}>
                                    ...
                                    <svg width="11" height="11" viewBox="0 0 24 24" stroke="none"><defs><linearGradient id="half"><stop offset="60%" stopColor="#ff492c" /><stop offset="60%" stopColor="#e2e8f0" /></linearGradient></defs><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" fill="url(#half)" /></svg>
                                </div>
